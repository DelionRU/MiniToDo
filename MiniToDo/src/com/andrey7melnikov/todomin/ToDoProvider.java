...
//      + CONTACT_NAME + " text, " + CONTACT_EMAIL + " text" + ");" ;
  ...
  // // Uri
  // authority
  static final String AUTHORITY = "ru.com.andrey7melnikov.todomin.provider";
  ...
  public Cursor query(Uri uri, String[] projection, String selection,
    ...
    Cursor cursor = mSqlDb.query(CONTACT_TABLE, projection, selection,
  ...
  public Uri insert(Uri uri, ContentValues values) {
    ...
    mSqlDb = dbHelper.getWritableDatabase();
    long rowID = mSqlDb.insert(CONTACT_TABLE, null, values);
  ...
  public int delete(Uri uri, String selection, String[] selectionArgs) {
    ...
    mSqlDb = dbHelper.getWritableDatabase();
    int cnt = mSqlDb.delete(CONTACT_TABLE, selection, selectionArgs);
  ...
  public int update(Uri uri, ContentValues values, String selection,
    ...
    mSqlDb = dbHelper.getWritableDatabase();
    int cnt = mSqlDb.update(CONTACT_TABLE, values, selection, selectionArgs);
    getContext().getContentResolver().notifyChange(uri, null);
    return cnt;
  }
